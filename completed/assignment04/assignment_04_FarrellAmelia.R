...
## sex vs. earn
ggplot(heights_df, aes(x=sex, y=earn)) + geom_point(outlier.colour = "red", outlier.size = 1) + geom_boxplot()
## race vs. earn
ggplot(heights_df, aes(x=race, y=earn)) + geom_point(outlier.colour = "red", outlier.size = 1) + geom_boxplot()
...
ggplot(data=florida_df, aes(x=date, group=1)) +
  ...
  geom_line(data=florida_df, aes(y = cases), color="steelblue")

...
days <- c("Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saterday")
...
Eight_hours <- week1_sleep > 8
table(Eight_hours)["TRUE"]
...
grades <- cbind(grades, assignment03, deparse.level = 0)

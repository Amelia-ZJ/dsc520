...
## `height` vs. `earn`
ggplot(heights_df, aes(x=height, y=earn)) + geom_point(colour = "blue", size = 1)
## `age` vs. `earn`
ggplot(heights_df, aes(x=age, y=earn)) + geom_point(colour = "green", size = 1)
## `ed` vs. `earn`
ggplot(heights_df, aes(x=ed, y=earn)) + geom_point(colour = "pink", size = 1)
...
## `age` vs. `earn`
ggplot(heights_df, aes(x=age, y=earn)) + geom_point(colour = "green", size = 1) +  geom_smooth()
## `ed` vs. `earn`
ggplot(heights_df, aes(x=ed, y=earn)) + geom_point(colour = "pink", size = 1) +  geom_smooth()
